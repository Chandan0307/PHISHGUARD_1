...
import validators  # Import validators package for URL validation
...
def predict_phishing():
        if request.method=="GET":
            ...
            if not validators.url(input_url):
                return render_template('index.html', error_message='Invalid URL')  # Return error message if URL is invalid
            ...
            return render_template('index.html', prediction="Safe" if y_pred == 1 else "Not Safe")

# Route for the contact page
@app.route('/contact', methods=['GET', 'POST'])
def contact():
    if request.method == 'POST':
        # Here you can handle the form submission, e.g., sending an email to the developer
